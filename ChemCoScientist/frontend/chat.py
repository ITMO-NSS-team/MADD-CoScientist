...
#
#     # print(f'PA_METADATA: {paper_analysis}')
#     print(f'IMAGES_CONTEXT: {images_context}')
#
#     # Initialize checkbox states in the message if not present
#     if "checkbox_states" not in message:
#         message["checkbox_states"] = {
#             "show_text": False,
#             "show_images": False,
#             "show_meta": False
#         }
...
#             "📄 Text Context",
#             value=message["checkbox_states"]["show_text"],
#             key=f"text_context_{message_index}"
#         )
#         message["checkbox_states"]["show_text"] = show_text
#
#     with col2:
#         show_images = st.checkbox(
#             "🖼️ Image Context",
#             value=message["checkbox_states"]["show_images"],
#             key=f"image_context_{message_index}"
#         )
#         message["checkbox_states"]["show_images"] = show_images
#
#     with col3:
#         show_meta = st.checkbox(
#             "ℹ️ Metadata",
#             value=message["checkbox_states"]["show_meta"],
#             key=f"metadata_{message_index}"
#         )
#         message["checkbox_states"]["show_meta"] = show_meta
#
#     # Display text context if selected
#     if show_text:
#         with st.expander("📄 Text Context", expanded=True):
...
#             if images_context:
#                 for i, image_item in enumerate(images_context):
#                     # Initialize image checkbox states if not present
#                     if "image_checkboxes" not in message["checkbox_states"]:
#                         message["checkbox_states"]["image_checkboxes"] = {}
#
#                     show_img = st.checkbox(
#                         f"{i + 1}. {image_item}",
#                         value=message["checkbox_states"]["image_checkboxes"].get(i, False),
#                         key=f"img_checkbox_{message_index}_{i}"
#                     )
#                     message["checkbox_states"]["image_checkboxes"][i] = show_img
#
#                     # Display image if selected
#                     if show_img:
#                         try:
