...
'web_search' - searches the internet to complement results from 'paper_analysis_node'. Use it right after  
    ...
    "configurable": {
        ...
        "prompts": {
            ...
            "planner": {
                ...
                For questions about papers, articles, or research findings, plan exactly two steps: first 'paper_analysis_node', 
                then 'web_search'. Do not schedule any other agents for such research tasks. 
            ...
            "summary": {
                ...
                present the final answer as: paper_analysis: <paper_analysis_agent result>   
                web_search: <web_search_node result>.""",
            },
            "replanner": {
                "problem_statement": None,
                "rules": None,
