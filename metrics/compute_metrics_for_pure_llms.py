...
def pipeline_test_with_save(
        ...
        version: float,
        out_dir: Path,
        paper_store: ChromaDBPaperStore = None
) -> pd.DataFrame:
    """Tests pipeline.
...
if __name__ == "__main__":
    ...
    # model_url = 'https://openrouter.ai/api/v1;google/gemini-2.5-pro'

    model_name = "gpt-5"
    model_url = 'https://openrouter.ai/api/v1;openai/gpt-5'
    ...
    pipeline_test_with_save(
        all_questions, [correctness_metric], model_name, model_url, v, out_dir
    )
