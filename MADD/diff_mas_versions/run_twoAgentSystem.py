...
import pandas as pd
from MADD.diff_mas_versions.six_case_multi_agents_proto.tools import (add_answers,
                                                 check_total_answer,
                                                 exctrac_mols_and_props,
                                                 validate_conductor,
                                                 validate_decompose)
from MADD.diff_mas_versions.system_architecture_zoo import TwinsChain
from MADD.diff_mas_versions.tools.two_agent_tools import (
...
if __name__ == "__main__":
    ...
    path = "multi_agents_system/multi_agents_system/experiment3_clear.xlsx"
