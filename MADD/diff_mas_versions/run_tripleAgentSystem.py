...
import pandas as pd
from MADD.diff_mas_versions.compute_metrics import (add_answers,
                                                 check_total_answer,
                                                 exctrac_mols_and_props,
                                                 validate_conductor,
                                                 validate_decompose)
from MADD.diff_mas_versions.system_architecture_zoo import TripleChain
from MADD.diff_mas_versions.tools.three_agent_tools import (
    gen_mols_acquired_drug_resistance, gen_mols_alzheimer,
    gen_mols_dyslipidemia, gen_mols_lung_cancer, gen_mols_multiple_sclerosis,
    gen_mols_parkinson, request_mols_generation)
from protollm.agents.llama31_agents.llama31_agent import Llama31ChatModel

# run pipeline on test data
if __name__ == "__main__":
    path_rag = Path("MADD/dif_mas_version/rag_documents")
    ...
    path = "/projects/multi_agents_system/multi_agents_system/experiment3_clear.xlsx"
